...
const publications: PAPER[] = [
  {
    ...
    pub: 'CVPR(IEEE Conference on Computer Vision and Pattern Recognition) 2024',
  ...
  },
  {
    ...
    pub: 'ICLR (INTERNATIONAL CONFERENCE ON LEARNING REPRESENTATIONS), 2024',
  ...
  },
  {
    ...
    pub: 'NeurIPS(Conference on Neural Information Processing Systems), 2023, Datasets and Benchmarks Track',
    link: 'https://arxiv.org/abs/2306.06687',
    containerId: 'LAMM',
  },
];
