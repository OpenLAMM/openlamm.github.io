...
const config = {
  ...
  tagline: 'Shanghai Artificial Intelligence Lab',
  // favicon: 'img/favicon.ico',
  favicon: 'img/lamm_logo.png',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Hugging Face',
                href: 'https://huggingface.co/openlamm',
              },
              // {
              //   label: 'Discord',
        ...
        copyright: `Copyright © ${new Date().getFullYear()} LAMM. Built with Docusaurus.`,
      },
      prism: {
