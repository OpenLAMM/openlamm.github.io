...
We provide two 3D benchmark datasets, "Scan2Inst-benchmark" and "LAMM3D-Dataset-benchmark".

#### Scan2Inst-benchmark

If your MLLMs are trained with "Scan2Inst", you should use "Scan2Inst-benchmark" for evaluation.

We provide [NR3D](https://referit3d.github.io/) and [ShapeNet](https://shapenet.org/) for zero-shot evaluation, and ScanNet for finetuning evaluation. You can download processed pickle file from [here](https://opendatalab.com/LAMM/OctaviusDataset/tree/main/OctaviusDataset_3D/3D_Benchmark/meta_file).
